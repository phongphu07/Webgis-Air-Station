                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            include '../connect.php';
                            $id = $_GET['id'];
                            $query = mysqli_query($connect, "select * from category_news where id='$id'");
                            $data  = mysqli_fetch_array($query);
                            ?>

                            <!-- </div> -->
                            <div class="panel-body">
                                <form class="form-horizontal style-form" style="margin-top: 20px;" action="edit_category_action.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="meta_title" class="form-control" type="text" id="meta_title" type="text" value="<?php echo $data['meta_title']; ?>" required />
                                        </div>
                                    </div>
